...
commands_permission = {
    ...
    "version_command_permission": [766233124681547776, 766231587104620554, 766293535832932392, 791227395331457047, 768985670127058985],
    # ==========================
...
user_report_command_aliases = ['репорт', 'жалоба', 'зарепорть', 'пожаловаться', 'Репорт', 'Жалоба', 'Зарепортить', 'Пожаловаться']
# ==========================
