...
roles_for_members = {
    # Emoji-ID          # Role-ID
    818868967825080330: 818003458094399508,  # memer_role
    818865783479599154: 818860755763331072,  # gamer_role
    818870007810883614: 818004267084414976,  # anime_role
    818878406698598453: 818003143639433246,  # writer_role
    818877410950119434: 818002500111826978,  # musician_role
    818867326564565033: 818003818113269770,  # streamer_role
    818872164823728189: 818002281172697088,  # designer_role
    818874039178100776: 818001571710763028,  # programmer_role
    818848454708166707: 818748991135023125   # newspaper_role
}
roles_channel_info = {
    "general_roles_post_id": 819303389321232404,    
    "newspaper_role_post_id": 819303410645860372,
    "roles_channel_id": 768556053682978816
}
...
mini_games = {
    "notification_channel": 769205419276369931,  # ID-канала для уведомлений
    "slot_minimum_win": 100,  # Сумма минимального выигрыша
    "slot_maximum_win": 200,  # Сумма максимального выигрыша
}
# ===================================================================#
#                             ECONOMY                                #
# ===================================================================#
private_room_category = 769490405711413248
# Категория для добавления приватных каналов пользователей мини-игр
...
tic_tac_toe_command_aliases = ['кн', 'КН', 'к-н', 'К-н', 'К-Н', 'крестики-нолики', 'Крестики-нолики', 'Крестики-Нолики',
                               'КРЕСТИКИ-НОЛИКИ', 'ttt', 'TTT', 'Tic-Tac-Toe', 'Tic-tac-toe']
...
member_activity = ['активити', 'Активити', 'активность', 'Активность']
user_passport_aliases = ['паспорт', 'Паспорт', 'пользователь', 'Пользователь', 'статистика', 'Статистика']
# ==========================
...
add_role_command_aliases = ['добавить_роль', 'Добавить_роль', 'добавь_роль', 'Добавь_роль', 'выдай_роль', 'Выдай_роль']
