...
class MetaPeaceEmbedsCog(commands.Cog):
    ...
    async def news_embed(self, ctx):
        ...
        msg = (
            ...
            # Description
            "<:n2:817941992864481301> На ближайшее время в планах на реализацию:\n"
            "<:n2:817941992864481301> <:online:816332016551329832> `Общая переработка оформления сервера`;\n"
            "<:n2:817941992864481301> <:online:816332016551329832> `Реализация системы ролей`;\n"
            "<:n2:817941992864481301> <:online:816332016551329832> `Реализация внутривалютного магазина ролей`.\n\n"
        )
        await ctx.send(
            # Header
