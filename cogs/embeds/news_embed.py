...
class MetaPeaceEmbedsCog(commands.Cog):
    ...
    async def news_embed(self, ctx):
        ...
        msg = (
            ...
            f"<:n2:817941992864481301> Сегодня были произведены незначительные работы с исходным кодом...\n"
            "<:n2:817941992864481301> <:online:816332016551329832> `Добавлена новая мини-игра: 'крестики-нолики' (см. в <помощь>)`;\n"
            "<:n2:817941992864481301> <:online:816332016551329832> `Внесен ряд изменений в систему 'слот-машины'`;\n"
            "<:n2:817941992864481301> <:online:816332016551329832> `Переименован лог-канал 'casino' -> 'mini-games'`;\n"
            "<:n2:817941992864481301> <:online:816332016551329832> `Переосмыслена система логирования лог-канала 'mini-games'`;\n"
            "<:n2:817941992864481301> <:online:816332016551329832> `А также внесены незначительные правки для стабильности`.\n"
            "\n"
        )
        await ctx.send(
            # Header
